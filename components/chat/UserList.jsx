...
export default function UserList({
  ...
  handleModalOpen,
  handleCreateGroup,handleJoinGroup, showGroupModal,
  setShowGroupModal, groupName,
  setGroupName, groupsFriends,
  ...
  return (
    <div className={`md:col-span-1 ${selectedUser && isMobileView ? 'hidden' : 'block'} overflow-y-auto`}>
        ...
        <div className="overflow-y-auto h-[calc(100%-8rem)]">
          {chatLoading==='fetchRecentChats'
            ...
            >
              ...
              <DropdownMenuItem onClick={()=>handleGroupSettings(recentUser?.groupId)}>Settings</DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem
